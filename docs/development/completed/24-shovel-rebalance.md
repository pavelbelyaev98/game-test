...
- Windows build succeeded with zero errors/code warnings; expected Pipeline notice concerns disabled editor services in players. Normal 1920x1080 startup/HUD inspected, no gameplay exceptions in log. Same executable; no new assets or disposable tools.
