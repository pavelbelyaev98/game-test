...
- Assets: explicit approval for the pair recorded in `docs/asset-ledger.md`; `art/stations/Stations.blend`, FBX exports, baked albedo/normal textures and prefabs retained. Only authored flap/drawer transforms animate.
