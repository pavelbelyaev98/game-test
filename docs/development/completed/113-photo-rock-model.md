...
- Delivery: `PhotoRock.blend`, visual FBX (12,500 triangles), separate convex collider FBX (84 triangles), reproducible recipe, manifest/license and four rendered views (temporary capture cleaned). Existing Blender scenes were preserved.
