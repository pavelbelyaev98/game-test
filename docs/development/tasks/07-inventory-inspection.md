...
Feature: [inventory](../../features/progression.md). [Queue](../tasks.md). [Research basis](../../research/player-review-findings.md).
...
- Production acceptance after `08`: inspect the existing scrollable UI Toolkit inventory from 74 at full capacity and supported review-window sizes, using the shared theme and approved presentation assets; preserve the existing identity and input checks. Discovery, economy and persistence retain their own acceptance contracts.
