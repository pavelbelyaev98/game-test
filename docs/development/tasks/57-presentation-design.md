...
- Consume the revised [56 progression](56-progression-design.md)/[120 Shave](120-powered-excavation-feel-design.md) decisions and [user/report verdict](../../research/keep-digging-lessons.md) before briefing a production silhouette. The [four-mode tool](../../features/backlog/excavation-modes.md) is an admin-only experiment, not accepted art or progression; its audio is removed. `11` retains reviewed installation/material staging and `153` comprehension. Preserve Sunny r8, current grass, ordinary Scoop and comfortable aiming; no generic firearm ladder, mandatory recoil or sounds.
