...
- Acceptance: valid purchases immediately increase usable slots, survive save/relaunch and preserve every existing item; duplicate/stale/unaffordable offers cannot alter state. Full-bag finds remain collectable after upgrading, with correct scrollable inspection and no identity duplication. Review a real trip and Windows build.
