...
Type: implementation. Status: `ready`, next after `134`. Reopened after the user found the delivered layer still too sparse; resume the recorded work ahead of `106`.
