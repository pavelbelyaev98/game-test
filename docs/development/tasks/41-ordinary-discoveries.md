...
Remaining ordinary types, completing the agreed 20–30 including `09`. Use the reviewed named roster in [Task 40](../../development/tasks/40-discovery-roster.md); this is a production integration task, not an asset brief alone.
