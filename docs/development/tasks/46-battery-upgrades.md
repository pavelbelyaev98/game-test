...
Type: implementation. Status: `planned`. Prerequisites: 45, 25, 35, 56.
...
- After `35`, `25`, `15` and `45`, add sequential money purchases with clear current-to-next capacity/effect and durable owned levels. Accepted digging and affordable active thrust still share one battery; standing/looking/jumping remain free.
