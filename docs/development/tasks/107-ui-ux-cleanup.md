...
- [118](118-bottom-action-bar.md) owns the new backpack/action bar using this task's shared theme and `106`'s layout. Keep that delivery separate from the current-UI cleanup and do not wait for optional C4 gameplay to finish either task.
