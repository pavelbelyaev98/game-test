...
- Include `154`’s experimental excavation switch: no release menu/button/cycle action or legacy v6 save may activate it, and no trial rig/overlay should load during ordinary play.
