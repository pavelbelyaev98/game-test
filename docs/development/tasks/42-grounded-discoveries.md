# Task 42 - First recognizable discovery and scale batch
...
First five recognizable slice objects from `40`, reusing retained content where appropriate, including handheld/appliance/occasional vehicle-scale cases after their handling is selected. Use the reviewed named roster in [Task 40](../../development/tasks/40-discovery-roster.md); this is a production integration task, not an asset brief alone.

## Research and questions before implementation

Research recognizable partial silhouettes and plausible groupings; ask for the named batch's asset approval.
...
This batch supplies `10`'s actual non-minor targets and `51`'s first personal records for `148`. Complete the reviewed small batch and its actual uncovering/reward experience before broad `41`/`43`/`44` modelling. Object themes and large-object extraction remain review/asset gated; the current 32 m site stays.
