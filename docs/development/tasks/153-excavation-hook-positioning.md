# Task 153 - Test excavation positioning with honest silent clips
...
Record build/clip versions, comprehension and confusion, then review the recommended pitch/sequence with the user. Route failures to the slice/presentation owner; copy cannot repair an unclear core action.

Done when the user reviews the concrete positioning artifact and the presentation feature records the selected wording/direction and limitations. Delete completed temporary review clips under repository policy; retain only the written findings unless the user requests deliverable marketing footage. No paid campaign or public upload follows automatically.
