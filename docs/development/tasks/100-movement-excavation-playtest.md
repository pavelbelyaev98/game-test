...
- Keep mechanical control separate from missing production visuals/audio. `102` must later judge the finished feedback; this test cannot pass unfinished presentation by proxy.
