...
Type: design/research; documentation only. Status: `planned`. Prerequisites: `15`, `56`, `57`, `63`.
...
- Consume the **drained reservoir** premise explicitly selected in [130](130-clouds-and-drained-reservoir.md), without re-asking it. 130 owns the requested surface setting/cloud presentation around the current footprint; this task retains material progression and any later footprint/performance implications. [Earlier setting comparison](../../research/starter-setting-and-items.md).
