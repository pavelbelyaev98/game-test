# Same-save achievements

Status: Task `53` is planned after ending/Continue (`52`), discovery display (`51`) and full-run pacing (`37`). No platform achievement implementation exists.

Idea coverage: sections 28 and 48.

Design: [55 - achievement list, unlock rules and durable tracking](../../development/tasks/55-achievement-design.md) precedes content production; `53` implements the accepted set and Steam integration later.
...
See [numbered Task `53`](../../development/tasks/53-steam-achievements.md) for scope, research, questions and acceptance.
