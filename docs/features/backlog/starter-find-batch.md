...
**Currently disabled for new games:** the rock-only playtest from `126` is extended with eight approved minerals by [145](../../development/tasks/145-depth-mineral-progression.md). All three bottles retain assets, save keys and compatibility aliases for existing saves. Their selected dimensions, **60% exposure** and detached physics remain below. Task [110](../../development/tasks/110-bottle-physics-and-recognition.md) removed cans/bricks; they are not approved to return automatically. The retained bottle art remains replaceable trial art.

[114](../../development/tasks/114-rock-variants-integration.md) integrates one common Rock with three appearances: A hollow, B/C solid, all with random 3D spawn rotation. Its [separate source guide](../../../art/photo-rock/README.md) owns allocation/replacement. [145](../../development/tasks/145-depth-mineral-progression.md) now uses 96 shallow rocks alongside 928 minerals; this document owns the retained inactive bottle subset.
