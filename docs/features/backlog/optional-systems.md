...
Status: implementation remains deferred until the full loop feels good. [71 - dynamite research](../../development/tasks/71-dynamite-design-research.md) evaluates one existing candidate; research completion does not select it. User-requested [idea assessment](../../research/player-idea-assessment.md) adds concrete design comparisons, not new delivered systems.
