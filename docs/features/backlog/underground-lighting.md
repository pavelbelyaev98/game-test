...
The current scene has no dedicated player light. The user explicitly requested natural cave-light correction without light items on 2026-09-12. Task `105` supplies full sun occlusion and excavation-dependent ambient daylight/reflection attenuation. [145](../../development/tasks/145-depth-mineral-progression.md) extends excavation to 32 m and raises the existing ambient minimum from 0.14 to 0.45 for readable mineral colors. Connected-air falloff and sun occlusion remain; open-sky lighting stays 1. This baseline is implemented; the headlamp/tool-light proposal below remains unselected and paused. Task `68` reviews that proposal using [comfort findings](../../research/player-review-findings.md#physical-comfort); numerical settings remain implementation tuning hypotheses.
