...
- Borderless/exclusive fullscreen, ultrawide/4:3 guarantees, controller/rebinding, integrated-GPU/8 GB tiers, ARM/emulation, Linux/Deck and automatic benchmarking remain uncommitted. Selecting these targets does not add those features or graphics-setting menus.
