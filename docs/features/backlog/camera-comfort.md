...
- Add **Camera comfort** immediately after Resume in Pause. Developer access and Save and quit remain accessible; automatic rescue is governed by `86`; fit the production/development variants at the [supported window sizes](release-validation.md#windows-support-targets), including 960×540.
