...
Status: decision framework for the three full prototypes; comparison playtests have not started. A narrower [one-pepper Chushkopek Stage 0 spike](chushkopek-stage0.md) has been implemented and awaits personal hands-on acceptance. Its technical checks do not populate this comparison. Created 2026-09-05.
...
| --- | --- | --- |
| [Chushkopek Season](chushkopek-prototype.md) | Roasting, steaming, and peeling remain satisfying across repeated peppers. | One active roasting socket becomes three. |
...
| --- | --- |
| [Reusable Unity blueprint](../../Ideas/game_type.md) | Immediate feedback, authored transformations, explicit state ownership, recoverable interactions. |
| [Earlier concept exploration](../../Ideas/ideas.md) | Test ordinary clearing before relying on hidden finds. |
| [Chopping Trees](../../Ideas/A_Game_About_Chopping_Trees_Case_Study.md) | Make the single upgrade perceptible and retain the original action afterward. |
| [Prison Escape](../../Ideas/Prison_Escape_Simulator_Dig_Out_Case_Study.md) | Avoid forced inactivity and progression blocked by object placement. |
| [20-game meta-study](../../Ideas/Simulator_Games_Meta_Study_20_Games_Blueprint.md) | Keep support friction small; identify why the player wants one more action. |
| [Leaf / Librarian](../../Ideas/Leaf_it_Alone_and_Librarian_Case_Study.md) | Visible order and player competence can motivate play without an economy or random loot. |
| [Cash Cleaner](../../Ideas/Cash_Cleaner_Simulator_Case_Study.md) | A few meaningful object states; satisfying processing feedback; controlled placement. |
| [Drywall Eating](../../Ideas/Drywall_Eating_Simulator_Case_Study.md) | Distinguish liking the premise from enjoying the action personally. |
| [Final ideas](../../Ideas/Final_Game_Ideas_Bulgarian_Traditions_and_Meme_Sims.md) | Preserve the three chosen fantasies while removing speculative systems. |
