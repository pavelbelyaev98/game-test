...
Genuinely undecided choices, with current options and leanings. None block the first prototype.
Once a choice is made, document it in the relevant chapter and remove it here.
...
Tune recognition, discovery spacing, net income, upgrades, charge and return burden together.
