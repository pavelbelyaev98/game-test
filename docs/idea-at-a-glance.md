...
Use the numbered task and its linked feature/research context for work. Read the intentionally long [full idea](idea.md) when those sources need more concept detail; preserve recorded choices rather than reconstructing them from chat. [Art style](features/backlog/art-style.md) records the selected bright cartoon direction inspired by Berry Bury Berry and A Game About Digging a Hole: simple readable items, clear authored detail and vivid colors. The user accepted Sunny r8 ground and natural daylight; `105` is complete. Upright moving grass remains future implementation and specific asset-batch approval in `08`. Future assets follow the shared guide.
