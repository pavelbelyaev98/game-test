...
Grandpa asks the adult player character to help with “just a few peppers.” The yard immediately contradicts him: crates lean against the fence, sacks obstruct the shed, a wheel peeks out of a mound, and something substantial hides under a tarp.

This is one unhurried autumn Sunday of family winter preparation. The food is for Grandpa and relatives in the city. That explains the quantity and gives finished work a purpose without adding errands or a seasonal deadline.

## The story follows what the player uncovers

**The scale mismatch.** A very small appliance sits beside a very large problem. The crate is available immediately, so the joke leads into a useful load instead of a slow tutorial.

**Equipment Grandpa already owns.** The wheelbarrow emerges with its folded loader. The starting feeder and reused fittings suggest his habit of solving domestic problems with improbable hardware. Each useful discovery changes the next load.

**A lived-in household.** Clearing the shed approach reveals an old refrigerator used as a tool cupboard, with a grinder inside. A recipe card, returned jars, old labels, and family photos suggest years of work here. They are scenery, not collectible or preparation requirements.
