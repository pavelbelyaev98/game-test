...
The scope includes responsive scooping, stable carrying, broad tipping, automatic processing, collecting output, depositing once at the sole handoff rack, pause, restart, and a recoverable carrier. M1–M2 together stay within the [interaction prototype boundary](../scope-and-validation.md#next-experiment-one-pile-one-carrier-one-discovery). No Grandpa dialogue, household display states, final machine, cellar, parcels, grinder, ending scene, or disk saves enter this prototype.
