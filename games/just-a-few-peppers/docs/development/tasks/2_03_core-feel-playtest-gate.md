...
Read the [common context and task protocol](readme.md#context-for-every-new-chat), then: [Scope and validation](../../scope-and-validation.md) · [Testing and performance](../testing-and-performance.md) · [Roadmap](../roadmap.md). Inspect the actual code, scenes, packages, and predecessor's delivery record; the brief does not prove that implementation exists.
