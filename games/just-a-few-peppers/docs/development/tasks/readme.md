...
**NEXT: 1_07.** The [1_06 physical-handling revision](1_06_loose-yard-objects-and-playful-handling.md#physical-handling-revision-delivery--september-6-2026) implements the researched grab/release controls and ordinary physics, with a verified player and new human feedback pending. Preserve quiet F1 help and apply any supplied play feedback first. Physical single/bulk peppers belong to 1_07; direct operation/output grouping remains 1_08.
...
| [1_06](1_06_loose-yard-objects-and-playful-handling.md) | Loose yard objects and playful handling | Feature | Ready for human playtest | Not tested | [Physical-handling revision](1_06_loose-yard-objects-and-playful-handling.md#physical-handling-revision-delivery--september-6-2026) · [Earlier feedback and research](1_06_loose-yard-objects-and-playful-handling.md#human-feedback-and-research-first-revision--september-6-2026) |
