...
**Outcome:** Deliver the complete M1 loop as an inspectable scene and Windows smoke build, and provide a lightweight developer checkpoint before M2.
...
Next in order: [2_01 — Wheelbarrow discovery and loader](2_01_wheelbarrow-discovery-and-loader.md). Stop after this task's handoff unless the developer explicitly requested a larger range.
