...
**Outcome:** Make uncovering a useful tool change the player's next load.

**Depends on:** [1_05 — First playable comfort and handoff](1_05_first-playable-comfort-and-handoff.md). All earlier play gates must also be resolved under the queue rules.
