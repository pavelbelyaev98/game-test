...
See the [task queue](games/just-a-few-peppers/docs/development/tasks/readme.md) for current delivery/feedback, the [milestone status](games/just-a-few-peppers/docs/development/status.md) for aggregate progress, and the [play guide](games/just-a-few-peppers/unity/readme.md) to run the current game. Research and comparison proposals do not establish that the loop is fun.
