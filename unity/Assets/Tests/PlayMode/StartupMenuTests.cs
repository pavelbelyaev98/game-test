...
namespace SomethingDownThere.Tests
{
    public sealed class StartupMenuTests
    {
        ...
        public IEnumerator ConfirmedNewGameResetsWorldProgressAndKeepsSettingsAndArchive()
        {
            ...
            Assert.That(player.Discoveries.Finds.Count, Is.EqualTo(2231));
            Assert.That(player.Discoveries.Finds.Count(f => f.SaveContentId.StartsWith("mineral_")), Is.EqualTo(1578));
