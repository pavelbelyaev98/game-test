// URP 17.6 Lit declarations/forward pass adapted for excavation ambient occlusion.
// Copyright (c) Unity Technologies. Unity Companion License for Unity-dependent
